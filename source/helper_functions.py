...
def run_sql_agent_workflow(user_query:str,input_agent:Agent,output_agent:Agent,previous_sql_queries,print_progess:bool=False):
    ...
    sql_input_agent_query = build_sql_input_agent_query(user_query=user_query,
...
def build_sql_input_agent_query(user_query:str,previous_sql_queries:List[str] = None) -> str:
    ...
    if previous_sql_queries:
        input_query = {'user_query': user_query,
                       'sql_queries': previous_sql_queries}
    #building sql_input_agent's first query when no previous attempt has been made
    else:
        input_query = str({'user_query': user_query,'sql_queries':[]})
    return input_query
