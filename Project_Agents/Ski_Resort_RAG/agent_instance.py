...
resort_agent = Agent(
    ...
    the characteristics of ski resorts.
    """,
    instructions= """
    You're a catalogue of information about ski resorts, your job is to return information to the user.
    ...
    Specific Instructions:
        ...
        of the information is 'resort_traits.csv'.
    """,
